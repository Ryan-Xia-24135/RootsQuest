...
} satisfies Record<FoldHinge, { origin: string; rotateX: number; rotateY: number }>;
...
export default function FoldText({
  ...
  useEffect(() => {
    ...
    if (trigger === "hover") {
      gsap.set(pieces, { opacity: 1, rotateX: 0, rotateY: 0, "--fold-crease": 0, transformOrigin: config.origin });
