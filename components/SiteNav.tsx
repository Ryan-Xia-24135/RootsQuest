...
export default function SiteNav() {
  return (
    <nav className="grid h-[72.45px] w-full grid-cols-[1fr_auto_1fr] items-center bg-black/30 px-[clamp(10px,2.65vw,40px)] font-['Asta_Sans',Arial,sans-serif] text-white">
