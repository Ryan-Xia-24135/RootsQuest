      ...
      <div className="mx-auto grid h-full max-w-[1480px] grid-cols-[1.08fr_0.92fr] gap-[clamp(12px,2vw,30px)] max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:gap-3">
        <section className="flex min-h-0 flex-col overflow-hidden rounded-[clamp(18px,2vw,30px)] border border-white/15 bg-black/35 p-[clamp(18px,3vw,44px)] shadow-[0_28px_70px_rgba(0,0,0,0.32)] backdrop-blur-[3px] max-sm:shrink-0 max-sm:p-3">
          <div className="shrink-0">
            ...
            <h1 className="m-0 font-['Asta_Sans',Arial,sans-serif] text-[clamp(26px,min(4vw,6vh),60px)] font-semibold leading-[1.06] tracking-[-0.03em] max-sm:text-[clamp(22px,7vw,28px)]">What Truly is ROOTS Quest?</h1>
            <p className="mt-[clamp(12px,2vh,20px)] max-w-[48ch] font-['Inter',Arial,sans-serif] text-[clamp(12px,min(1.55vw,2.65vh),23px)] font-normal leading-[1.45] max-sm:mt-2 max-sm:max-w-none max-sm:text-[13.5px] max-sm:leading-[1.35]">ROOTS Quest is an 8-week project-based STEM program for students in Grades 6–8 that teaches young people to see the world differently.</p>
            <p className="mt-[clamp(10px,1.7vh,17px)] max-w-[48ch] font-['Inter',Arial,sans-serif] text-[clamp(12px,min(1.55vw,2.65vh),23px)] font-normal leading-[1.45] max-sm:mt-1.5 max-sm:max-w-none max-sm:text-[13.5px] max-sm:leading-[1.35]">Rather than beginning with solutions or answers, students first learn how to understand the systems behind the problems they care about.</p>
          </div>
