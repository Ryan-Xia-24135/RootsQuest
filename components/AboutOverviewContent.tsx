...
export default function AboutOverviewContent() {
  return (
    <div className="absolute inset-0 z-10 overflow-hidden text-white">
      ...
      <p className="absolute left-[3.17%] top-[16.9%] m-0 flex h-[11.61%] w-[56.81%] items-center overflow-y-auto font-['Inter',Arial,sans-serif] text-[clamp(12px,min(2.12vw,3.5vh),32px)] font-normal leading-[1.2] tracking-[-0.03em] max-md:left-[5%] max-md:top-[20%] max-md:h-[10%] max-md:w-[90%] max-md:text-[clamp(10px,min(3.25vw,2.8vh),18px)]">
      ...
      <p className="absolute left-[3.17%] top-[32.69%] m-0 flex max-h-[13.5%] w-[46.56%] -translate-y-1/2 items-center overflow-y-auto font-['Inter',Arial,sans-serif] text-[clamp(12px,min(2.12vw,3.5vh),32px)] font-normal leading-[1.2] tracking-[-0.03em] max-md:left-[5%] max-md:top-[40.5%] max-md:h-[18%] max-md:max-h-[18%] max-md:w-[43%] max-md:translate-y-0 max-md:text-[clamp(10px,min(3.25vw,2.8vh),18px)]">
      ...
      <div className="absolute left-[3.17%] top-[47.25%] h-[39.5%] w-[46.56%] overflow-hidden rounded-br-[16px] rounded-tl-[16px] rounded-tr-[24px] max-md:left-[5%] max-md:top-[56%] max-md:h-[24%] max-md:w-[55%] max-md:rounded-[10px]">
        <Image
          className="object-cover"
      ...
      <p className="absolute right-[3.7%] top-[55.19%] m-0 flex h-[32.48%] w-[37.37%] items-center justify-end overflow-y-auto text-right font-['Inter',Arial,sans-serif] text-[clamp(12px,min(2.12vw,3.5vh),32px)] font-normal leading-[1.2] tracking-[-0.03em] max-md:right-[5%] max-md:top-[56%] max-md:h-[25%] max-md:w-[31%] max-md:text-[clamp(9px,min(3vw,2.5vh),16px)]">
